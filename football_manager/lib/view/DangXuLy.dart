...
import 'package:football_manager/view/unvote.dart';
import 'package:football_manager/view/vote_page.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:url_launcher/url_launcher.dart';

class WaitHistoryBookingPage extends StatefulWidget {
  @override
  WaitHistoryBookingPageState createState() =>
      WaitHistoryBookingPageState();
}

class WaitHistoryBookingPageState extends State<WaitHistoryBookingPage> {
  @override
                              ...
                              child: Container(
                                ...
                                child: FlatButton(
                                    onPressed: () {
                                      ...
                                      Navigator.of(context).push(MaterialPageRoute(builder: (context) => UnVotePage()));
                                    },
                                    child: Text(
                                      'Hủy sân',
                                      style: TextStyle(
